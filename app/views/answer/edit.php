    ...
    <div data-uk-grid class="uk-width-1-2 uk-margin-large-top uk-align-center">
        ...
        <form method="POST" class="uk-form">
            ...
            <div class="uk-form-row uk-width-1-1">
                <?php if($answer['question_name'] != null): ?>
                    Вопрос: "<?= $answer['question_name'] ?>"
                <?php endif; //if($answer['question_name'] != null) ?>
            </div>
            <div class="uk-form-row uk-width-1-1">
                <?= $html_element['name']->render(); ?>
            </div>
            <div class="uk-form-row uk-width-1-1">
                <?= $html_element['complexity_coefficient']->render(); ?>
            </div>
            <div class="uk-form-row uk-width-1-1">
            ...
            echo renderDescriptionDatetimeFIO($answer);
            ?>
